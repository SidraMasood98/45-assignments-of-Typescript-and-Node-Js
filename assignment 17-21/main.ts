...
let guests : string [] = ["sara", "sana", "Hira" ,"Madiha", "Nazia", "Hamra"];
...
let $guest : string [] = ["sara", "sana"];
$guest.map((items) => (console.log(`dear ${items}, you are still invited to the dinner.`)));
...
let placeToVisit : string[] = ["England", "China", "Pakistan", "SWitzerland", "Greece"];
...
// • Reverse the order of your list. Print the array to show that its order has changed.
console.log("Reversed order:", [...placeToVisit].reverse());
...
// • Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order has changed.
console.log("sorted in reverse alphabetic order:", [...placeToVisit].sort().reverse());
...
// inviting to dinner.
let invitations: string[] = ["sara" ,"sana"];
...
let languages : string[] = ["urdu", "English", "spanish", "chinese", "French"];
console.log("languages spoken in the world:");
console.log(languages);

// Q21-
// They think of something you could store in a TypeScript Object. Write a program that creates Objects containing these items.
let mySelf : {name: string, gender: string, age: number} = {name: "sidra", gender: "female", age: 32};
console.log(mySelf);