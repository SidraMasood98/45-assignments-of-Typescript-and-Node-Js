...
console.log("My favourite food is \"".concat(favouriteFood, "\""));
// Q11-
...
//  one at a time.
var names = ["Beena", "Madiha", "Nazia", "Hamra"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
var names1 = ["Beena", "Madiha", "Nazia", "Hamra"];
var message = "would you like to have a cup of tea?";
...
var vehicles = ["Honda Motorcycle.", "BMW.", "sportage."];
...
var guests1 = ["Beena", "Madiha", "Nazia", "Hamra"];
var cannotattend = "Beena";
console.log("".concat(cannotattend, ", cannot attend the party."));
var newguest = "sana";
guests1[guests1.indexOf(cannotattend)] = newguest;
console.log(guests1);
guests1.map(function (items) { return (console.log("dear ".concat(items, ", you are invited yo the dinner."))); });
// Q16-
...
// part 1
var guests = ["sana", "Madiha", "Nazia", "Hamra"];
guests.map(function (items) { return (console.log("dear ".concat(items, ", \"Great news! I have found a bigger dinner table\"."))); });
//part 2
var guestBeg = "sara";
guests.unshift(guestBeg);
console.log(guests);
//part 3
var middleGuest = "hira";
...
console.log(guests);
//part 5
guests.map(function (items) { return console.log("\"dear ".concat(items, ", you are coodially invited on bigger dinner table.\" ")); });
